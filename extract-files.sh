...
adb pull /system/lib/libomx_evrcdec_sharedlibrary.so ../../../vendor/motorola/$DEVICE/proprietary/lib
...
adb pull /system/lib/libomx_wmadec_sharedlibrary.so ../../../vendor/motorola/$DEVICE/proprietary/lib
adb pull /system/lib/libopencore_arcaudiolocal.so ../../../vendor/motorola/$DEVICE/proprietary/lib
adb pull /system/lib/libopencore_arcaudiolocalreg.so ../../../vendor/motorola/$DEVICE/proprietary/lib
...
PRODUCT_COPY_FILES := \\
    ...
    vendor/motorola/__DEVICE__/proprietary/lib/hw/gralloc.omap3.so:obj/lib/hw/gralloc.omap3.so

PRODUCT_COPY_FILES += \\
    vendor/motorola/__DEVICE__/proprietary/app/PhoneConfig.apk:/system/app/PhoneConfig.apk \\
...
PRODUCT_COPY_FILES += \\
    ...
    vendor/motorola/__DEVICE__/proprietary/lib/hw/gralloc.omap3.so:/system/lib/hw/gralloc.omap3.so \\
